...
package com.tarchanyn.simpletodo.data.source.local;
...
import com.tarchanyn.simpletodo.data.source.local.TasksPersistenceContract.TaskEntry;
...
public class TasksLocalDataSource implements TasksDataSource {
    ...
    public void getTasks(@NonNull LoadTasksCallback callback) {
        ...
        if (c != null && c.getCount() > 0) {
            while (c.moveToNext()) {
                ...
                Task task = new Task(title, description, itemId, priority);
                tasks.add(task);
            }
        }
        if (c != null) {
    ...
    public void getTask(@NonNull String taskId, @NonNull GetTaskCallback callback) {
        ...
        if (c != null && c.getCount() > 0) {
            ...
            int priority =
                    c.getInt(c.getColumnIndexOrThrow(TaskEntry.COLUMN_NAME_PRIORITY));
            task = new Task(title, description, itemId, priority);
        }
        if (c != null) {
            c.close();
        }
